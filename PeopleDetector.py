...
#face_cascade= cv2.CascadeClassifier("/home/govtech/opencv/data/haarcascades/haarcascade_frontalface_alt.xml")
#eye_cascade= cv2.CascadeClassifier("/home/govtech/opencv/data/haarcascades/haarcascade_eye.xml")
...
minArea = 8000  # default min area to be considered person
maxArea = 25000  # default max area to be considered person
humanSize = 10000
sampleSize = 100
noFrameToCollectSample = 100
toleranceRange = 250  # use for error calculation
...
with pyrs.Service() as serv:
    with serv.Device() as dev:
        ...
        while True:
            ...
            #     if allowPassage:
            #         cv2.line(gray, (int(boundaryPt1[0]), int(boundaryPt1[1])),
            #                 (int(boundaryPt2[0]), int(boundaryPt2[1])), (0, 255, 0), 2)
            #     else:
            #         cv2.line(gray, (int(boundaryPt1[0]), int(boundaryPt1[1])),
            #                 (int(boundaryPt2[0]), int(boundaryPt2[1])), (0, 0, 255), 2)
            ...
            #     cv2.putText(frameInfo, textNoOut, (30, 120), cv2.FONT_HERSHEY_SIMPLEX
            #                 , 1, (255, 255, 255), 1, cv2.LINE_AA)
            #     cv2.line(frameInfo, (0, 160), (640, 160), (0, 255, 255), 1)
            #     cv2.putText(frameInfo, "VIOLATION", (30, 200), cv2.FONT_HERSHEY_SIMPLEX
            #                 , 1, (255, 255, 255), 1, cv2.LINE_AA)
            #     cv2.putText(frameInfo, textNoViolationIn, (30, 240), cv2.FONT_HERSHEY_SIMPLEX
            #                 , 1, (255, 255, 255), 1, cv2.LINE_AA)
